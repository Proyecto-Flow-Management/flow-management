...
public final class XMLConstants {
    ...
    //XML Templates
    public static final String GUIDE_XML_LOCATION = "resources/XMLResources/GuideXML.xml";
    public static final String STEP_XML_LOCATION = "resources/XMLResources/StepXML.xml";
    public static final String SIMPLE_OPERATION_XML_LOCATION = "resources/XMLResources/SimpleOperationXML.xml";
    public static final String TASK_OPERATION_XML_LOCATION = "resources/XMLResources/TaskOperationXML.xml";
    public static final String IN_PARAMETER_XML_LOCATION = "resources/XMLResources/InParameterXML.xml";
    public static final String OUT_PARAMETER_XML_LOCATION = "resources/XMLResources/OutParameterXML.xml";
    public static final String PROPERTY_XML_LOCATION = "resources/XMLResources/PropertyXML.xml";
    public static final String ALTERNATIVE_XML_LOCATION = "resources/XMLResources/AlternativeXML.xml";
    public static final String REFERENCE_DOC_XML_LOCATION = "resources/XMLResources/ReferenceDocXML.xml";
    public static final String UNARY_CONDITION_XML_LOCATION = "resources/XMLResources/UnaryConditionXML.xml";
    public static final String BINARY_CONDITION_XML_LOCATION = "resources/XMLResources/BinaryConditionXML.xml";
    public static final String OPERATOR_UNO_UNARY_CONDITION_XML_LOCATION = "resources/XMLResources/Operator1UnaryXML.xml";
    public static final String OPERATOR_DOS_UNARY_CONDITION_XML_LOCATION = "resources/XMLResources/Operator2UnaryXML.xml";
    public static final String OPERATOR_UNO_BINARY_CONDITION_XML_LOCATION = "resources/XMLResources/Operator1BinaryXML.xml";
    public static final String OPERATOR_DOS_BINARY_CONDITION_XML_LOCATION = "resources/XMLResources/Operator2BinaryXML.xml";
    public static final String CONDITION_ENABLE_ALTERNATIVE_LOCATION = "resources/XMLResources/ConditionParameterXML.xml";
    public static final String ALTERNATIVE_IDS_XML_LOCATION = "resources/XMLResources/AlternativeIdsXML.xml";
    public static final String OPERATION_NOTIFY_IDS_XML_LOCATION = "resources/XMLResources/OperationNotifyIdsXML.xml";
    public static final String CANDIDATE_GROUPS_XML_LOCATION = "resources/XMLResources/CandidateGroupsXML.xml";
    public static final String CONVERTION_XML_LOCATION = "resources/XMLResources/ConvertionXML.xml";
    public static final String VALIDATE_CROSS_FIELD_CONDITION_XML_LOCATION = "resources/XMLResources/ValidateCrossFieldConditionXML.xml";
    public static final String OPTION_VALUE_XML_LOCATION = "resources/XMLResources/OptionValueXML.xml";
    ...
    // AUX
    public static final String GUIDE_RESULT = "resources/XMLResources/GuideResult.xml";
